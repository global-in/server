        ...
        <div style="width: 93%">
            <div style="width: 100%" class="post-content">
                ...
                <div class="post-menu-container" style="width:10%;">
                    <button class="pre-400" style="color: var(--gray700); cursor: pointer">공유</button>
                    <button class="pre-400" style="color: var(--gray700); cursor: pointer">수정</button>
                    <button class="pre-400" style="color: var(--gray700); cursor: pointer">삭제</button>
                </div>
            </div>
